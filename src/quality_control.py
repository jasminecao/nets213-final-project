...
Original file is located at
    https://colab.research.google.com/drive/1VeLnAWUabnQy3HUTfEYKbnawazjjk4fv
"""
...
def main():
    ...
    for i, row in df1.iterrows():
      worker = row['WorkerId']
      for i in range(1, 15):
        tuple_list.append((row['WorkerId'], row['Input.results' + str(i)], row['Answer.results' + str(i) + '.Yes']))
